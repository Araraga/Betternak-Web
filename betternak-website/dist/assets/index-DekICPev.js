...
`)+`
`+m);const x=v+p+o,S=v+m+a,R=kh(i,i.VERTEX_SHADER,x),w=kh(i,i.FRAGMENT_SHADER,S);i.attachShader(g,R),i.attachShader(g,w),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function E(L){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(g).trim(),N=i.getShaderInfoLog(R).trim(),z=i.getShaderInfoLog(w).trim();let G=!0,B=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(G=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,R,w);else{const K=zh(i,R,"vertex"),Y=zh(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
